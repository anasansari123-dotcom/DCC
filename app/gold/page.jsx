...
export default function BronzeBundlePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Top Header Section */}
   <div className="bg-gradient-to-r from-yellow-300 via-yellow-400 to-yellow-500 text-white">
    ...
    <div className="grid md:grid-cols-2 gap-8 items-center">
      ...
      <div className="flex space-x-8 mt-6 md:mt-0">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="font-semibold">23 Courses</span>
        </div>

        {/* Hours */}
        <div className="flex items-center space-x-2">
          <span className="text-yellow-200 text-2xl">⏳</span>
          <span className="font-semibold">70 Hours</span>
        </div>

        {/* Students */}
        <div className="flex items-center space-x-2">
          <span className="text-blue-200 text-2xl">👥</span>
          <span className="font-semibold">70K+ Students Enrolled</span>
        </div>
      </div>
    </div>
  </div>
...
<div className="bg-white rounded-2xl shadow-lg p-6">
  ...
  <div className="relative bg-yellow-100 rounded-xl p-8 mb-6 overflow-hidden">
    {/* Decorative Background Elements */}
    <div className="absolute top-4 right-4 w-16 h-16 bg-yellow-200 rounded-full opacity-60"></div>
    <div className="absolute bottom-4 left-4 w-12 h-12 bg-yellow-200 rounded-full opacity-60"></div>

    {/* Main Illustration */}
    <div className="relative z-10 text-center">
      {/* Play Button Overlay */}
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="w-20 h-20 bg-gradient-to-br from-yellow-300 via-yellow-400 to-yellow-500 hover:from-yellow-400 hover:to-yellow-600 rounded-full flex items-center justify-center shadow-lg transition-all cursor-pointer">
          <svg
      ...
      <div className="flex items-center justify-center space-x-8 text-yellow-900">
      ...
      {/* Cloud Shapes */}
      <div className="absolute top-2 left-8 text-2xl opacity-30 text-yellow-400">
        ☁️
      </div>
      <div className="absolute bottom-2 right-8 text-2xl opacity-30 text-yellow-400">
        ☁️
      </div>
    </div>
  </div>
  ...
  <div className="text-center mb-6">
    <div className="flex items-center justify-center space-x-4">
      <span className="text-4xl font-bold text-yellow-700">₹6,999</span>
      <span className="text-xl text-yellow-600 line-through">₹7,999</span>
    </div>
    <p className="text-sm text-yellow-800 mt-2">Limited Time Offer</p>
  </div>

  {/* Buy Now Button */}
  <button
    onClick={handleBuyNow}
    className="w-full bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 hover:from-yellow-500 hover:to-yellow-700 text-white font-bold py-4 px-6 rounded-xl transition-all duration-200 hover:shadow-lg transform hover:-translate-y-0.5"
  >

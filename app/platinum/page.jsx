    ...
    <div className="grid md:grid-cols-2 gap-8 items-center">
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-xl font-semibold text-gray-100">
            Skills That Drive Digital Success!
          </p>
        </div>
      </div>
      ...
      <div className="flex space-x-8 mt-6 md:mt-0">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="font-semibold">25 Courses</span>
        </div>

        {/* Hours */}
        <div className="flex items-center space-x-2">
          <span className="text-yellow-200 text-2xl">⏳</span>
          <span className="font-semibold">83 Hours</span>
        </div>

        {/* Students */}
        <div className="flex items-center space-x-2">
          <span className="text-pink-200 text-2xl">👥</span>
          <span className="font-semibold">50K+ Students Enrolled</span>
        </div>
      </div>
    </div>
  </div>
...
<div className="bg-white rounded-2xl shadow-lg p-6">
  ...
  <div className="relative bg-blue-100 rounded-xl p-8 mb-6 overflow-hidden">
    ...
    <div className="relative z-10 text-center">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="w-20 h-20 bg-gradient-to-br from-blue-300 via-blue-500 to-blue-600 hover:from-blue-400 hover:to-blue-700 rounded-full flex items-center justify-center shadow-lg transition-all cursor-pointer">
      ...
      {/* Cloud Shapes */}
      <div className="absolute top-2 left-8 text-2xl opacity-30 text-blue-400">☁️</div>
      <div className="absolute bottom-2 right-8 text-2xl opacity-30 text-blue-400">☁️</div>
    </div>
  </div>
  ...
  <div className="text-center mb-6">
    <div className="flex items-center justify-center space-x-4">
      <span className="text-4xl font-bold text-blue-700">₹12,999</span>
      <span className="text-xl text-blue-500 line-through">₹13,999</span>
    </div>
    <p className="text-sm text-blue-800 mt-2">Limited Time Offer</p>
  </div>

  {/* Buy Now Button */}
  <button
    onClick={handleBuyNow}
    className="w-full bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 hover:from-blue-500 hover:to-blue-700 text-white font-bold py-4 px-6 rounded-xl transition-all duration-200 hover:shadow-lg transform hover:-translate-y-0.5"
  >

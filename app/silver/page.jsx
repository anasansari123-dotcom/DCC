...
export default function BronzeBundlePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Top Header Section */}
    <div className="bg-gradient-to-r from-gray-200 via-gray-300 to-gray-400 text-black">
    ...
    <div className="grid md:grid-cols-2 gap-8 items-center">
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-xl text-gray-700">
            Stand Out, Get Noticed, Grow Digitally
          </p>
        </div>
      </div>
      ...
      <div className="flex space-x-8 mt-6 md:mt-0">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="font-semibold text-gray-900">14 Courses</span>
        </div>

        {/* Hours */}
        <div className="flex items-center space-x-2">
          <span className="text-yellow-600 text-2xl">⏳</span>
          <span className="font-semibold text-gray-900">52 Hours</span>
        </div>

        {/* Students */}
        <div className="flex items-center space-x-2">
          <span className="text-purple-500 text-2xl">👥</span>
          <span className="font-semibold text-gray-900">90K+ Students Enrolled</span>
        </div>
      </div>
    </div>
  </div>
...
<div className="bg-white rounded-2xl shadow-lg p-6">
  ...
  <div className="relative bg-gray-100 rounded-xl p-8 mb-6 overflow-hidden">
    {/* Decorative Background Elements */}
    <div className="absolute top-4 right-4 w-16 h-16 bg-gray-200 rounded-full opacity-60"></div>
    <div className="absolute bottom-4 left-4 w-12 h-12 bg-gray-200 rounded-full opacity-60"></div>

    {/* Main Illustration */}
    <div className="relative z-10 text-center">
      {/* Play Button Overlay */}
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="w-20 h-20 bg-gradient-to-br from-gray-200 via-gray-300 to-gray-400 hover:from-gray-300 hover:to-gray-500 rounded-full flex items-center justify-center shadow-lg transition-all cursor-pointer">
          <svg
      ...
      {/* Cloud Shapes */}
      <div className="absolute top-2 left-8 text-2xl opacity-30 text-gray-400">
        ☁️
      </div>
      <div className="absolute bottom-2 right-8 text-2xl opacity-30 text-gray-400">
        ☁️
      </div>
    </div>
  </div>
  ...
  <div className="text-center mb-6">
    <div className="flex items-center justify-center space-x-4">
      ...
      <span className="text-xl text-gray-500 line-through">₹3,999</span>
    </div>
  ...
  <button
    ...
    className="w-full bg-gradient-to-r from-gray-300 via-gray-400 to-gray-500 hover:from-gray-400 hover:to-gray-600 text-black font-bold py-4 px-6 rounded-xl transition-all duration-200 hover:shadow-lg transform hover:-translate-y-0.5"
  >
